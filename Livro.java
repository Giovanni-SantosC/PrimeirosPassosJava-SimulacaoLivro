...
public class Livro implements Publicacao{
	...
	public Livro(String ti, String au, int tp, Pessoa le,int pg) {
		setTitulo(ti);
		setAutor(au);
		setAberto(false);
	...
	public void fechar() {
		...
		System.out.println("Livro Esta Fechando.");
	}
	...
	public void folhear() {
		...
		if(this.getAberto()) {
			...
			System.out.println("Impossivel Folhear, Livro Esta Fechado.");
		}
	}
